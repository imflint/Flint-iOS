...
public protocol CollectionService {
    ...
    func fetchWatchingCollections() -> AnyPublisher<RecentViewedCollectionsDTO, Error>
}
...
public final class DefaultCollectionService: CollectionService {
    ...
    public func fetchWatchingCollections() -> AnyPublisher<RecentViewedCollectionsDTO, Error> {
