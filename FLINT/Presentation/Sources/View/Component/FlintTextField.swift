...
public final class FlintTextField: UITextField {
    
    // MARK: - Property
    
    public var maxLength: Int?
    public var onLengthChanged: ((_ textLength: Int, _ maxLength: Int) -> Void)?
    ...
    public init(placeholder: String, maxLength: Int? = nil, showLength: Bool = false) {
