...
public final class ExploreEmptyCollectionViewCell: BaseCollectionViewCell {
    ...
    public let mainStackView = UIStackView().then {
        $0.axis = .vertical
        $0.spacing = 47
        $0.alignment = .center
    ...
    public let textStackView = UIStackView().then {
        $0.axis = .vertical
        $0.spacing = 8
        $0.alignment = .center
        $0.distribution = .equalSpacing
