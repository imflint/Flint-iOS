...
class CollectionTitleTableViewCell: BaseTableViewCell {
    ...
    let textField = FlintTextField(placeholder: "컬렉션 제목을 입력해주세요", maxLength: 20)
    
    let textFieldLengthLabel = UILabel().then {
        $0.textColor = .flintWhite
