...
final class SelectedContentReasonTableViewCell: BaseTableViewCell {
    
    var onTapClose: (() -> Void)?
    var onToggleSpoiler: ((Bool) -> Void)?
    var onChangeReasonText: ((String) -> Void)?
    ...
    func configure(with item: SelectedContentReasonTableViewCellItem) {
